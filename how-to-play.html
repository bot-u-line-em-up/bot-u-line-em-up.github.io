...
![Jumping and moving in Super Mario Bros. 3](./Images/Walkthrough/TutIntro.gif)
...
![Jumping higher and moving longer in Super Mario Bros. 3](./Images/Walkthrough/TutDuration.gif)
...
![Turnaround jump in Super Mario Bros. 3](./Images/Walkthrough/TutSequence.gif)
...
![Running in Super Mario Bros. 3](./Images/Walkthrough/TutHold.gif)
...
![Timing jumps in Super Mario Bros. 3](./Images/Walkthrough/TutDelay.gif)
...
![Run then stop running in Super Mario Bros. 3](./Images/Walkthrough/TutRelease.gif)
...
![Jumping and running at the same time in Super Mario Bros. 3](./Images/Walkthrough/TutSimultaneous.gif)
...
![Hitting a block multiple times in Super Mario Bros. 3](./Images/Walkthrough/TutRepeated.gif)
...
![Controlling Mario and Luigi at the same time in Super Mario Bros. 3](./Images/Walkthrough/TutMultiController.gif)
...
![Macro to move right in Super Mario Bros. 3](./Images/Walkthrough/TutMacros.gif)
...
![Going through part of 1-1 in Super Mario Bros. 3 through an input sequence](./Images/Walkthrough/TutCulmination.gif)
...
- Factor in the state of the playable character while playing. If your character is in the air or a lengthy animation, chances are they can't jump or do anything else until they're back on their feet or finished with what they were doing. Time your delays accordingly! 
...
What comes next? [See more examples](./Play-Examples.md) and give TRBot a try! [Set up your own](./Setup-Init.md), or play through an instance deployed on a stream. [Players have achieved great feats with TRBot](./Real-Usage-Examples.md)!

For even more details on the input syntax, including comments, dynamic macros, and percentages for analog inputs, read the more technical [syntax tutorial](./Syntax-Tutorial.md).
